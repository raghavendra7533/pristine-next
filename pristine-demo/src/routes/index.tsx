...
const STATES = [
  { id: 0, dur: 3200 }, // NL search
  { id: 1, dur: 3600 }, // results - persona expanded
  { id: 2, dur: 3800 }, // results - firmographics expanded
  { id: 3, dur: 3200 }, // profile
  { id: 4, dur: 3000 }, // objective
  { id: 5, dur: 3200 }, // generated
  { id: 6, dur: 2400 }, // tweak
  { id: 7, dur: 3400 }, // improved
];
...
function Demo() {
  ...
  return (
    <div ref={wrapRef} className="min-h-screen w-full flex items-center justify-center bg-[oklch(0.97_0.015_270)] p-2 sm:p-4 font-sans overflow-hidden">
      <div
