...
const zoomInfoPageJsonLd = [
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Pristine vs ZoomInfo', item: 'https://pristinedata.ai/compare/pristine-vs-zoominfo' },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function PristineVsZoomInfoPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(zoomInfoPageJsonLd) }} />
      <Navbar />
